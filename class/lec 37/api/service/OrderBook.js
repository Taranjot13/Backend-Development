...
class OrderBook{
    ...
    placeOrder(price,quantity,type,side,userName){
        ...
        return {book:this.getBookSnapShot(),trades:this.getLatestTrade(),newOrder}
    }
...
// Export the class for use by other modules. Keep the self-test code
// behind a main check so requiring this file doesn't execute it.
module.exports = OrderBook;

// If this file is run directly, run a small demo/test sequence.
